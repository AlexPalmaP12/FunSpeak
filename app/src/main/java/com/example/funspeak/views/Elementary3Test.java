...
public class Elementary3Test extends AppCompatActivity {
    ...
    public void setUpActions(){
        multiplication.setOnClickListener((view)->nextActivity("multiplication3"));
        division.setOnClickListener((view)->nextActivity("division3"));
        addition.setOnClickListener((view)->nextActivity("addition3"));
        subtraction.setOnClickListener((View)->nextActivity("subtraction3"));
    }
